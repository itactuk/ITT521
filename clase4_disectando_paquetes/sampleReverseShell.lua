...
campo_numerico= ProtoField.int32 ("si.num", "mi numero"    , base.DEC)
campo_texto           = ProtoField.string("si.texto"           , "mi texto"             , base.ASCII)
...
.dissector(buffer, pinfo, tree)
  ...
  pinfo.cols.protocol = protocolo_shellInverso.name
